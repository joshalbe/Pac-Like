...
int main()
{
	...
	Maze::TileKey newMap[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ w, w, _, w, _, w, _, _, _, _, _, _, _, s, s, _, _, _, _, _, _, _, w, _, w, _, w, w },
		{ w, w, _, w, _, _, w, _, _, _, g, _, s, s, s, s, g, _, _, _, _, w, _, _, w, _, w, w },
		{ w, w, _, _, _, _, _, _, _, _, _, s, s, _, _, s, s, _, _, _, _, _, _, _, _, _, w, w },
		{ w, w, _, w, _, _, w, _, _, _, _, _, s, s, s, s, _, _, _, _, _, w, _, _, w, _, w, w },
		{ w, w, _, w, _, w, _, _, _, _, _, _, _, s, s, _, _, _, _, _, _, _, w, _, w, _, w, w },
		{ w, w, _, w, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, w, _, w, w },
