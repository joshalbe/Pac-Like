...
int main()
{
	...
	Maze::TileKey pacMap[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ w, w, w, w, w, w, _, w, w, _, _, _, _, _, _, _, _, _, _, w, w, _, w, w, w, w, w, w },
		{ w, w, w, w, w, w, _, w, w, _, _, _, _, _, _, _, _, _, _, w, w, _, w, w, w, w, w, w },
		{ _, _, g, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ },
		{ w, w, w, w, w, w, _, w, w, _, _, _, _, _, _, _, _, _, _, w, w, _, w, w, w, w, w, w },
		{ w, w, w, w, w, w, _, w, w, _, _, _, _, _, _, _, _, _, _, w, w, _, w, w, w, w, w, w },
		{ w, w, w, w, w, w, _, w, w, _, _, _, _, _, _, _, _, _, _, w, w, _, w, w, w, w, w, w },
	...
	Maze::TileKey newMap[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ w, w, _, w, _, _, w, _, _, _, g, _, _, _, _, _, g, _, _, _, _, w, _, _, w, _, w, w },
		{ w, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, w },
		{ w, w, _, w, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, w, _, w, w },
		{ w, w, _, w, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, w, _, w, w },
		{ w, w, _, w, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, w, _, w, w },
