...
int main()
{
	...
	Maze::TileKey newMap[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ w, w, _, _, _, w, w, w, w, w, w, w, w, _, _, w, w, w, w, w, w, w, w, _, _, _, w, w },
		{ w, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, w },
		...
		{ w, w, _, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, _, w, w },
		{ w, w, _, w, _, _, _, _, w, _, _, _, _, g, _, _, _, _, _, w, _, _, _, _, w, _, w, w },
		{ w, w, _, w, _, _, _, w, _, _, _, _, _, s, _, _, _, _, _, _, w, _, _, _, w, _, w, w },
		{ w, w, _, w, _, w, _, _, _, _, _, _, s, s, s, _, _, _, _, _, _, _, w, _, w, _, w, w },
		{ w, w, _, w, _, _, w, _, _, _, g, s, s, _, s, s, g, _, _, _, _, w, _, _, w, _, w, w },
		{ w, w, _, _, _, _, _, _, _, _, _, _, s, s, s, _, _, _, _, _, _, _, _, _, _, _, w, w },
		{ w, w, _, w, _, _, w, _, _, _, _, _, _, s, _, _, _, _, _, _, _, w, _, _, w, _, w, w },
		{ w, w, _, w, _, w, _, _, _, _, _, _, _, g, _, _, _, _, _, _, _, _, w, _, w, _, w, w },
		{ w, w, _, w, _, _, _, w, _, _, _, _, _, _, _, _, _, _, _, _, w, _, _, _, w, _, w, w },
		{ w, w, _, w, _, _, _, _, w, _, _, _, _, _, _, _, _, _, _, w, _, _, _, _, w, _, w, w },
		{ w, w, _, w, _, _, _, _, _, _, _, w, _, _, _, _, w, _, _, _, _, _, _, _, w, _, w, w },
		{ w, w, _, w, _, w, w, w, w, w, _, _, _, _, _, _, _, _, w, w, w, w, w, _, w, _, w, w },
		{ w, w, _, w, _, _, _, _, _, w, _, _, w, _, _, w, _, _, w, _, _, _, _, _, w, _, w, w },
		{ w, w, _, w, _, _, _, w, _, w, _, _, w, _, _, w, _, _, w, _, w, _, _, _, w, _, w, w },
		{ w, w, _, w, _, w, _, _, _, w, _, _, w, _, _, w, _, _, w, _, _, _, w, _, w, _, w, w },
		{ w, w, _, w, _, w, w, _, _, w, _, _, w, _, _, w, _, _, w, _, _, w, w, _, w, _, w, w },
		{ w, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, w },
		{ w, w, _, _, _, w, w, w, w, w, w, w, w, _, _, w, w, w, w, w, w, w, w, _, _, _, w, w },
		{ w, w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w, w },
		{ w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w },
